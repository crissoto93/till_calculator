...
async function runTests() {
  ...
  try {
    ...
    console.log('✓ Denomination multiple validation verified ($35 rejected for $20 bill)');

    // 4. Test valid POST /api/closings
    ...
    // Total cash: 300+100+200+40+10+5+1+0.5+0.1+0.4 = $657.00
    // Float: 200.00
    // Deposit: 457.00
    // Expected: 200.15
    // Discrepancy: 200.00 - 200.15 = -0.15
    assert.strictEqual(validClosingRes.json.closing.total_cash, 657.0);
    ...
    console.log('✓ Admin closings list retrieved successfully');
